      ...
      <div className="container-modern relative">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p
              className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-12 animate-fade-in-up text-balance"
              style={{ animationDelay: "200ms" }}
            >
              Take the first step towards building your real estate portfolio.
              Our team of experts is ready to guide you through every aspect of
              your investment journey.
            </p>
